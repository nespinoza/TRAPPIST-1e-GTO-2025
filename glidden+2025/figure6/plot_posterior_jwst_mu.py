...
x = mu# np.log10(CH4)#np.random.randn(1000)
...
mean,up,down = juliet.utils.get_quantiles(mu)
print('mu:',mean,'+',up-mean,'-',mean-down)

ax.set_xlabel(r'$\mu_{ghost}$', fontsize = 25)
ax.set_xlim(2.,100.)

ax.set_xticks([2, 30., 60., 90.], ['$2$', '$30$', '$60$', '$90$'])#'$-10$', '$-7.5$', '$-5.0$', '$-2.5$'])
ax.set_yticks([])
plt.savefig('posteriors_jwst_mu_hist.pdf',
