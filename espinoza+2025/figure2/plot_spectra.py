...
espinoza_color = '#6883ba'#'cornflowerblue'
...
for name, date in zip(['003', '001', '104', '002'], ['June 22', 'June 28', 'July 23', 'October 28']):
    ...
    ax[name].text(4.2,4400,date+', 2023', fontsize = 30)
    ...
    ax[name].errorbar(w_ne, d_ne, derr_ne, fmt = 'o', \
                      ecolor = 'black', \
                      mfc = 'black', \
                      mec = 'black', \
                      ms = ms, \
    ...
    """
    ax[name].errorbar(w_ag, d_ag, derr_ag, fmt = 'o', \
    ...
    ax[name].errorbar(w_dg, d_dg, derr_dg, fmt = 'o', \
                      ecolor = grant_color, \
                      mfc = grant_color, \
                      mec = grant_color, \
                      ms = ms, \
    ...
    ax[name].errorbar(w_scks, d_scks, derr_scks, fmt = 'o', \
    ...
    ax[name].errorbar(w_cc, d_cc, derr_cc, fmt = 'o', \
                      ecolor = canas_color, \
                      mfc = canas_color, \
                      mec = canas_color, \
                      ms = ms, \
